...
{
    public static string luaDir = Application.dataPath + "/3rd_Lib/ToLua/Lua/";                //lua逻辑代码目录
    public static string toluaDir = Application.dataPath + "/3rd_Lib/ToLua/ToLua/Lua/";        //tolua lua文件目录
